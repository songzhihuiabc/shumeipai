...
var NanoDLPService = function () {
  ...
  _createClass(NanoDLPService, [{
        ...
        return regeneratorRuntime.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                //return await this._request("/z-axis/info");
                data = new Promise(function (resolve, reject) {
                  request1({
                    uri: _this.serverURL + "/z-axis/info",
                    method: "GET",
                    headers: { Cookie: "" + (_this.auth ? _this.session : "") },
                    //type: type,
                    json: "json",
                    timeout: 10000
        ...
        return regeneratorRuntime.wrap(function _callee10$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 2:
                slicerdata = _context10.sent;
                return _context10.abrupt("return", slicerdata);
        ...
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                _context11.next = 2;
                return this._request("/printer/auto-shutdown/enable");
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              case 0:
                _context12.next = 2;
                return this._request("/printer/auto-shutdown/disable");
      ...
      function unautoShutdown() {
        return _ref12.apply(this, arguments);
      }

      return unautoShutdown;
    }()
  }, {
    key: "pause",
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee16$(_context16) {
          while (1) {
            switch (_context16.prev = _context16.next) {
              ...
              case 2:
                log = _context16.sent;
                return _context16.abrupt("return", JSON.parse(log.split("\n").slice(-1).toString().split(" ").slice(2).join(" ")));
    ...
    key: "command",
    value: function () {
      var _ref17 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(url) {
        ...
        return regeneratorRuntime.wrap(function _callee18$(_context18) {
          while (1) {
            switch (_context18.prev = _context18.next) {
              case 0:
                console.log("setGcode:", this.serverURL + "/term-io", data);
                _context18.next = 3;
                return (0, _requestPromiseNative2.default)({
                  uri: this.serverURL + "/term-io",
                  headers: { Cookie: "" + (this.auth ? this.session : "") },
                  form: data,
                  method: "POST"
                });
