...
var NextionService = function (_EventEmitter) {
  ...
  _createClass(NextionService, [{
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                ...
                this.port.write(this.zhongwenHex(cmd));
    ...
    key: 'zhongwenHex',
    value: function zhongwenHex(str) {
      console.log('zhongwenHex:', str);
      var strBuffer = new Buffer(str);
      var endBuffer = new Buffer([255, 255, 255]);

      console.log('zhongwenHexbuf:', [strBuffer, endBuffer]);

      return Buffer.concat([strBuffer, endBuffer]);
    }
  }]);
